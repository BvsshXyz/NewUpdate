...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To Bayu Vpn ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Author : ${green}Bayu Vpn® ${NC}${YELLOW}(${NC} ${green} Bayu Vpn ${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/BvsshXyz/NewUpdate/main/regis | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Order🐳","url":"https://t.me/BayuuVpn"},{"text":"Grub Tele🐦","url":"https://t.me/BayuuVpn"}]]}'
...
wget raw.githubusercontent.com/BvsshXyz/NewUpdate/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
